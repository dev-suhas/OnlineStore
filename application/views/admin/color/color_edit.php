    ...
    <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
      ...
      <div class="clearfix"></div>
	   <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 ">
          <ul class="btn_ul">
            <li> <a href="<?php echo base_url(); ?>admin/admin/state_view" class="btn btn-primary">View &nbsp;&nbsp;<i class="fa fa-eye" aria-hidden="true"></i></a> </li>
          </ul>
        </div>
	   </div>	
       ...
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">		 
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
               <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <h2 class="page_txt"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;&nbsp;Edit Color </h2>
                  </div>
			   </div>
				<?php foreach($state_list as $val){ ?>
		       <form action="<?php echo base_url(); ?>admin/admin/edit_color/<?php echo $val['id']; ?>" method="post" >
