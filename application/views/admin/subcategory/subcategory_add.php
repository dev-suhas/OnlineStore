  <div class="side_right">
	...
	<form action="<?php echo base_url(); ?>admin/admin/add_subcategory" method="post" enctype="multipart/form-data">
      <div class="form_body">
        <div class="row">
			<div class="col-lg-6">
			...
			<div class="col-lg-6">
				<div class="form-group">
				  <div class="row_form">
					...
					<input class="sq_form" placeholder="Sub Category" id="name" name="name"  type="text" >
			  ...
			  <div class="form-group">
				 <div class="row_form">
				   <div class="div_label">
					...
					<textarea class="sq_form" placeholder="Description" id="description" name="description"   required=""></textarea>
            ...
            <div class="col-lg-12">
                <div class="form-group">
                  <div class="row_form">
                    <div class="div_label">
                      <label class="text_label">Icon </label>
                    </div>
