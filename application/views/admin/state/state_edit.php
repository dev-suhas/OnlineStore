       ...
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">		 
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
               <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <h2 class="page_txt"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;&nbsp;Edit State </h2>
                  </div>
			   </div>
				<?php foreach($state_list as $val){ ?>
		       <form action="<?php echo base_url(); ?>admin/admin/edit_state/<?php echo $val['id']; ?>" method="post" >
