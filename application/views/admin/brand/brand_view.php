    ...
    <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
      ...
      <div class="clearfix"></div>
	   <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 ">
          <ul class="btn_ul">
            <li> <a href="<?php echo base_url();?>admin/admin/addNewBrand" class="btn btn-primary">Add New&nbsp;&nbsp;<i class="fa fa-plus" aria-hidden="true"></i></a> </li>
          </ul>
        </div>
	   </div>
	  </div>
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">
		  <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
			<div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 ">
                <h2 class="page_txt"><i class="fa fa-list-ol" aria-hidden="true"></i>&nbsp;&nbsp;List of Brand </h2>
              </div>
			 </div>		
					...
					<tr>
					  ...
					  <td><img src="<?= base_url().$val['photo']; ?>" alt="" height="85px"/></td>
			 		    <td><div class="btn-group">
						  <a href="<?php echo base_url();?>admin/admin/edit_brand/<?= $val['id']; ?>" class="btn btn-outline-info" style="padding:6px;" title="Edit"> <i class="fa fa-edit"></i></a>  
						  <a href="<?php echo base_url();?>admin/admin/delete_brand/<?= $val['id']; ?>"  onclick="return confirm('Are you sure you want to delete?')" class="btn btn-outline-danger" style="padding:6px;" title="Delete"> <i class="fa fa-trash"></i></a> 
						  </div>
					    </td>
					</tr>
					  <?php } }
