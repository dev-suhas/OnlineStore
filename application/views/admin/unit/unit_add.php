       ...
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">		 
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
		       ...
		       <form action="<?php echo base_url(); ?>admin/admin/add_unit" method="post" >
      ...
      <div class="form_body">
        ...
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder="Symbol" id="symbol" name="symbol"  type="text" >
        ...
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Base Quantity" id="base" name="base"  type="text">
