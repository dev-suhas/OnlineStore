    ...
    <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
      ...
      <div class="clearfix"></div>
	   <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 ">
          <ul class="btn_ul">
            <li> <a href="<?php echo base_url(); ?>admin/admin/unit_view" class="btn btn-primary">View &nbsp;&nbsp;<i class="fa fa-eye" aria-hidden="true"></i></a> </li>
          </ul>
        </div>
	   </div>	
       ...
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">		 
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
               <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <h2 class="page_txt"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;&nbsp;Edit Unit </h2>
                  </div>
			   </div>
				<?php foreach($unit_list as $val){ ?>
		       <form action="<?php echo base_url(); ?>admin/admin/edit_unit/<?php echo $val['id']; ?>" method="post" >
      ...
      <div class="form_body">
        ...
        <div class="form-group">
          <div class="row_form">
            <div class="div_label">
              <label class="text_label">Symbol <span class="red">*</span> </label>
            </div>
            <input class="sq_form" placeholder="Symbol" id="symbol" name="symbol" value="<?php echo $val['symbol']; ?>"  type="text" >
        ...
        <div class="form-group">
          <div class="row_form">
            <div class="div_label">
              <label class="text_label"> Base Quantity <span class="red">*</span></label>
            </div>
            <input class="sq_form" placeholder=" Base Quantity" id="base" name="base" value="<?php echo $val['base']; ?>"  type="text">
			  <?php echo form_error('base', '<div class="error">', '</div>'); ?>
          </div>
        </div>
      </div>	
