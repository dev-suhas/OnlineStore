    ...
    <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
      ...
      <div class="clearfix"></div>
	   <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 ">
          <ul class="btn_ul">
            <li> <a href="<?php echo base_url();?>admin/admin/add_district" class="btn btn-primary">Add New&nbsp;&nbsp;<i class="fa fa-plus" aria-hidden="true"></i></a> </li>
          </ul>
        </div>
	   </div>
	  </div>
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">
		  <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
			<div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 ">
                <h2 class="page_txt"><i class="fa fa-list-ol" aria-hidden="true"></i>&nbsp;&nbsp;List of District </h2>
              </div>
			 </div>		
				...
				<table class="table  table-hover srp_table" width="100%" border="1">
				  ...
				  <tbody>
					<tr>
					  ...
					  <td><strong style="margin-bottom: 5px;display: block;color: #ea6227;"><?=$val['state']; ?></strong></td>
					  <td><?= ($val['status']!=0) ? '<span class="badge badge-success">Active</span>' : '<span class="badge badge-danger">Inactive</span>'; ?></td>
					  <td><div class="btn-group"> 
						  <a href="edit_district/<?=$val['id']; ?>" class="btn btn-outline-info" style="padding:6px;" title="Edit"> <i class="fa fa-edit"></i></a> 
					  </div></td>
					</tr>
				  </tbody>
					<?php } }
