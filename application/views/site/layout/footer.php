...
============================================ -->
        ...
        <!--====== Vendors js ======-->
        <script src="<?php echo base_url('assets/website/js/vendor/jquery-3.5.1.min.js'); ?>"></script>
        <script src="<?php echo base_url('assets/website/js/vendor/modernizr-3.7.1.min.js'); ?>"></script>
        ...
        <script src="<?php echo base_url('assets/website/js/plugins/meanmenu.js'); ?>"></script>
        <script src="<?php echo base_url('assets/website/js/plugins/owl-carousel.js'); ?>"></script>
        <script src="<?php echo base_url('assets/website/js/plugins/jquery.nice-select.js'); ?>"></script>
        <script src="<?php echo base_url('assets/website/js/plugins/countdown.js'); ?>"></script>
        <script src="<?php echo base_url('assets/website/js/plugins/elevateZoom.js'); ?>"></script>
        <script src="<?php echo base_url('assets/website/js/plugins/jquery-ui.min.js'); ?>"></script>
        <script src="<?php echo base_url('assets/website/js/plugins/slick.js'); ?>"></script>
        <script src="<?php echo base_url('assets/website/js/plugins/scrollup.js'); ?>"></script>
        <script src="<?php echo base_url('assets/website/js/plugins/range-script.js'); ?>"></script>

        <!--====== Use the minified version files listed below for better performance and remove the files listed above ======-->

         <script src="<?php echo base_url('website/assets/js/plugins.min.js'); ?>"></script> 
